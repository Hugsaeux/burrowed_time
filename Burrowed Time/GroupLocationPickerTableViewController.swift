//
//  GroupLocationPickerTableViewController.swift
//  Burrowed Time
//
...
class GroupLocationPickerTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "groupLocationPickerCell", for: indexPath) as! GroupLocationPickerTableViewCell
        
        cell.locationLabel.text = cellTitles[indexPath.row]
        ...
        if (groupList.groups[groupList.getIndexOfGroup(groupName: currentGroup)].checkLocation(location: cellTitles[indexPath.row])) {
            ...
            cell.locationSwitch.isOn = false;
        }
